...
void list_print(list_t list);									// ispisuje sve vrijednosti elemenata liste (typedef int list_element_t)
void list_rotate_right(list_t list, unsigned d);				// rotira listu u desno za d mjesta
